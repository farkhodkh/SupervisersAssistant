package ru.haknazarovfarkhod.supervisersAssistant.ResideMenuComponents;
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customRightMenuId >= 0) {
            ...
            scrollViewRightMenu = inflater.inflate(
                    R.layout.main_reside_menu_right_scrollview, this, false);
        ...
        RelativeLayout menuHolder = (RelativeLayout) findViewById(R.id.main_reside_menu);
